...
namespace ocfa {
    ...
    void OcfaErrorHandler::error(const xercesc::SAXParseException & e){
        if (throwerr) throw OcfaException(evidence::DomHelper::transcode(e.getMessage()),this);
    }
    void OcfaErrorHandler::warning(const xercesc::SAXParseException & e){
        if (throwwarn) throw OcfaException(evidence::DomHelper::transcode(e.getMessage()),this);
    }
    void OcfaErrorHandler::fatalError(const xercesc::SAXParseException & e){
        throw OcfaException(evidence::DomHelper::transcode(e.getMessage()),this);
    }
}
