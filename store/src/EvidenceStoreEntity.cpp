...
namespace ocfa {
  namespace store {
    ...
    std::string EvidenceStoreEntity::TABLE_NAME = "evidencestoreentity";
    EvidenceStoreEntity::EvidenceStoreEntity(string root): StoreEntity(root) {
     
    }

    EvidenceStoreEntity::~EvidenceStoreEntity(){      
    }
    

    void EvidenceStoreEntity::setPermissions(int fd){
    ...
    string EvidenceStoreEntity::tableName(){ 
      return TABLE_NAME; 
    }

    ocfa::misc::OcfaHandle EvidenceStoreEntity::getHandle(){
      return d_handle;
    }

    void EvidenceStoreEntity::closeStream(){
    ...
    DigestPair *EvidenceStoreEntity::getDigestPair(){
